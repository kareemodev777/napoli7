...
const ORDER_SELECT =
  "id, order_number, status, pos_sync_status, customer_name, customer_phone, customer_email, delivery_type, delivery_address, delivery_slot, order_notes, pizza_cut, payment_method, payment_status, stripe_payment_intent, subtotal_aed, delivery_fee_aed, service_fee_aed, discount_aed, promo_code, total_aed, created_at, order_items(product_id, product_name, base_price_aed, quantity, line_total_aed, customizations, size_label)";
