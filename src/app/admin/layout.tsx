...
export default async function AdminLayout({
  ...
  return (
    <AdminNotificationsProvider initial={snapshot}>
      <main
        id="main"
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          {/* Floating notification — overlays the content at the top-right so it
              takes no vertical space and the page starts at the very top.
              Desktop only; mobile keeps the bell in the sidebar's own top bar. */}
